...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/bootstrap.min.css"/>">
  <!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"> -->

  <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/style.css"/>">
</head>
<body>
<section class="">
  <div class="container">
...
<script src="<c:url value="/templates/account/jquery-3.2.1.slim.min.js"/>"></script>
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script> -->

<script src="<c:url value="/templates/account/bootstrap.min.js"/>"></script>
</body>
</html>